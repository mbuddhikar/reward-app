...
:root {
  ...
  * {
  ...
  .section-large-text {
    position: relative;
    // background: url("https://i.ibb.co/1RS1dqC/section-b.jpg")
      no-repeat;
    height: 600px;
  }
...
class HomePage extends Component {
  ...
  render() {
    ...
    return (
      <WebContainer img={bg}>
        {/* <Button type="primary" onClick={this.naviagteToLogin}>Login</Button> */}

        <nav class="navbar">
          <div class="container">
            <h1 class="logo">Reward Lives</h1>
            <ul class="nav">
              <li><a onClick={this.naviagteToRegistration}>Registration</a></li>
              <li><a onClick={this.naviagteToLogin}>Login</a></li>
            </ul>
          </div>
        </nav>
        ...
        <section id="about" class="section-large-text">
          <div class="overlay">
            <div class="section-large-text-inner">
              <h3>Healthy Life & Rewards</h3>
              <h2>Earn Rewards for Your Daily Activities</h2>
            </div>
          </div>
        </section>
