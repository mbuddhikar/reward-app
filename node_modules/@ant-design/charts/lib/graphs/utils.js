...
// 展开&折叠事件
var bindDefaultEvents = function (graph, level) {
    var onClick = function (e) {
        var item = e.item;
        if (e.target.get('name') === 'collapse-icon') {
            var _a = item.getModel(), collapsed = _a.collapsed, g_currentPath = _a.g_currentPath, _b = _a.children, children = _b === void 0 ? [] : _b;
            var appendChildren = level &&
                !children.length &&
                (0, exports.getChildrenData)(graph.get('eventData').getData(), g_currentPath);
            if ((appendChildren === null || appendChildren === void 0 ? void 0 : appendChildren.length) > 0) {
                var currentData = (0, exports.setParentChildren)(graph.get('data'), g_currentPath, appendChildren);
