...
function useGraph(graphClass, config, extra) {
    ...
    (0, react_1.useEffect)(function () {
        if (container.current && graphClass) {
            ...
            var _b = nodeCfg_1 !== null && nodeCfg_1 !== void 0 ? nodeCfg_1 : {}, nodeType_1 = _b.type, nodeSize = _b.size, nodeAnchorPoints = _b.anchorPoints, nodeStateStyles = _b.nodeStateStyles, nodeStyle_1 = _b.style, nodeLabelCfg_1 = _b.title, linkCenter = _b.linkCenter;
            ...
            if (markerCfg) {
                ...
                sourceGraph.includes(name_1)
                    ...
                    : (0, utils_1.bindDefaultEvents)(graph_1, level);
            }
